...
python stealsimsiam.py --world-size -1 --rank 0  --pretrained models/checkpoint_0099-batch256.pth.tar --data /home/anon/data/imagenet --batch-size 512 --lr 0.1 --losstype 'infonce' --datasetsteal 'imagenet' --workers 8 --num_queries 250000 --useaug 'False' --temperature 0.25
