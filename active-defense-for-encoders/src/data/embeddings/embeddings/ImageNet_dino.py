...
def generate_embeddings(args):
    ...
    # Subset with random 50K images (same number per class)
    dataset_train = CustomImageNetDataset(os.path.join(args.data_path, "train"), transform=train_transform)
    dataset_val = CustomImageNetDataset(os.path.join(args.data_path, "val"), transform=val_transform)
    ...
    torch.save(embeddings_dataset_test, 'ImageNet_emb_val_dataset.pt')
    torch.save(embeddings_dataset_train, 'ImageNet50K_emb_train_dataset.pt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='../../../../datasets/ILSVRC/Data/CLS-LOC/', type=str)
