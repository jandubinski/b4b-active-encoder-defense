...
def generate_embeddings(args):
    ...
    dataset_train = datasets.SVHN(args.data_path, split="train", download=True, transform=train_transform)
    dataset_val = datasets.SVHN(args.data_path, split="test", download=True, transform=val_transform)
    ...
    torch.save(embeddings_dataset_test, 'svhn_emb_test_dataset.pt')
    torch.save(embeddings_dataset_train, 'svhn_emb_train_dataset.pt')
