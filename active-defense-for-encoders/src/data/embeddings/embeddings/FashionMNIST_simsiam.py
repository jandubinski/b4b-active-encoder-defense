...
def generate_embeddings(args):
   # ============ building network ... ============
    ...
    dataset_train = datasets.FashionMNIST(args.data_path, train=True, download=True, transform=transform_train)
    dataset_val = datasets.FashionMNIST(args.data_path, train=False, download=True, transform=transform_train)
    ...
    torch.save(embeddings_dataset_test, 'fmnist_emb_simsiam_test_dataset.pt')
    torch.save(embeddings_dataset_train, 'fmnist_emb_simsiam_train_dataset.pt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='./datasets/FashionMNIST/', type=str)
