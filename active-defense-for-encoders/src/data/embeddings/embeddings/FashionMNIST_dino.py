...
def generate_embeddings(args):
    ...
    dataset_train = datasets.FashionMNIST(args.data_path, train=True, download=True, transform=train_transform)
    dataset_val = datasets.FashionMNIST(args.data_path, train=False, download=True, transform=val_transform)
    ...
    torch.save(embeddings_dataset_test, 'fmnist_emb_test_dataset.pt')
    torch.save(embeddings_dataset_train, 'fmnist_emb_train_dataset.pt')
