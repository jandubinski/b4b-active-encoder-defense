...
def generate_embeddings(args):
  # ============ building network ... ============
    ...
    dataset_train = datasets.SVHN(args.data_path, split="train", download=True, transform=transform_train)
    dataset_val = datasets.SVHN(args.data_path, split="test", download=True, transform=transform_train)
    ...
    torch.save(embeddings_dataset_test, 'svhn_emb_simsiam_test_dataset.pt')
    torch.save(embeddings_dataset_train, 'svhn_emb_simsiam_train_dataset.pt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='./datasets/svhn/', type=str)
